namespace CRM.winForms.Forms
{
    partial class FrmCustomerList
    {
        ...
        private void InitializeComponent()
        {
            ...
            // tblHeader — 3 columns × 2 rows
            //   Row 0: Search | (empty) | Register Customer (right)
            //   Row 1: Show archived
            ...
            // ---- Row 0, col 2: flowButtons (right-aligned) ----
            ...
            this.btnRegisterCustomer.Width = 180;
            this.btnRegisterCustomer.Height = 32;
            this.btnRegisterCustomer.Margin = new System.Windows.Forms.Padding(0);
            ...
            this.flowButtons.Controls.Add(this.btnRegisterCustomer);

            this.tblHeader.Controls.Add(this.flowSearch, 0, 0);
            this.tblHeader.Controls.Add(this.flowButtons, 2, 0);
